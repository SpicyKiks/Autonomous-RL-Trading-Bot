...
def _make_run_id(mode: str, cfg_hash: str) -> str:
    return f"{_utc_ts()}_{mode}_{short_hash(cfg_hash, 10)}"


def main() -> int:
    parser = argparse.ArgumentParser(description="Train runner (Step 2 DB-integrated stub).")
